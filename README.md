...
released so researchers, occupational-health teams, mental-health services, and
other organizations can inspect, test, validate, and adapt the model in their
own settings.
...
- A fitted reference model trained on the 2020 NSDUH employed-adult analytic
  sample.
- The preprocessing steps needed to use the model correctly: median imputation
...
| `work_hours` | Usual weekly work hours |
...
- `si_xgb_full_2020_v0_1_0.joblib`
...
| Sensitivity at threshold 0.17 | 0.510 |
